...
class Zone_report extends CI_Controller {
    ...
    public function index() {
        ...
        if (in_array($this->session->userdata('role_id'), $per_role_arr)):
            ...
            $data['active_sub_menu'] = 'Zone Wise Reports';
            ...
            $data['technitian'] = $this->common_model->getzones();
            $data['getTable'] = '';
            $data['dashboard'] = '';
            ...
            $this->load->view('zone_report/zone_report', $data);
            $this->load->view('common/footer', $data);
            $this->load->view('common/js', $data);
            $this->load->view('zone_report/js_zone_report', $data);
	 ...
	 public function getDateSearch() { 
		...
		$data['technitian'] = $this->common_model->getzones($tech);
		...
		if(($fm != '' && $to != '')||($fm == '' && $to == '')){
			...
			$data['getTable'] = $this->common_model->getZoneDateWise($fm, $to, $type, $tech);		
			$this->load->view('common/header', $data);
			$this->load->view('zone_report/zone_report', $data);
			$this->load->view('common/footer', $data);
			$this->load->view('common/js', $data);
