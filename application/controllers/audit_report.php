...
class Audit_report extends CI_Controller {
    ...
    public function index() {
        ...
        if (in_array($this->session->userdata('role_id'), $per_role_arr)):
			...
			$type = '';$fm='';$to='';
		     $data['processData'] = $this->common_model->getAuditData($type, $fm, $to);
			 
			 
			 
			 
			$query1 = $this->db->query("select * from user  ");
            $data['name_user'] = $query1->result();
            ...
            $this->load->view('audit_report/audit_report', $data);
            $this->load->view('common/footer', $data);
            $this->load->view('common/js', $data);
            $this->load->view('audit_report/js_audit_report', $data);
	...
	public function getProccessData() {
        ...
        $type = mysql_real_escape_string($this->input->post('dealeby'));
