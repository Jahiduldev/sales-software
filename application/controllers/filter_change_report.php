...
class Filter_change_report extends CI_Controller {
...
$per_role_arr=array();
        ...
        if (in_array($this->session->userdata('role_id'), $per_role_arr)):
            ...
            $data['active_sub_menu'] = 'Filter Change report';
            ...
            $this->load->view('filter_change_report_ssp/filter_change_report_ssp',$data);
            $this->load->view('common/footer',$data);
            $this->load->view('common/js_ssp',$data);
            $this->load->view('filter_change_report_ssp/js_filter_change_report_ssp',$data);
