            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading" style="font-weight:bold; background:#F2682B; color:#fff;">
                        ...
                        if($role==1):
                         ?>
                        <a href="<?site_url('excel_filter')?>" class="pull-right"><b></b></a>
                         <?php endif;  ?>
                    </header>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="cmxform form-horizontal tasi-form" id="addCustomerForm"  role="form" method="post"  action="<?php echo site_url('general_request_filter/sendSms');  ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				action="<?php echo site_url('general_request_filter/addTechnitian');  ?>">
					<div class="form-group">
					...
					<div class="form-group">
                        ...
                        <div class="col-lg-9">                            
							...
							<select class="form-control" name="clientresponse" required>
