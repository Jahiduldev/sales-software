            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="cmxform form-horizontal tasi-form" id="addEmployeeForm"  role="form" method="post"  onSubmit="return buttonDisable();"  action="<?php echo site_url('add_employee/addEmployee');  ?>">

                            <div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2">Employee Code *</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Enter Employee Code" id="add_employee_code" name="add_employee_code" onchange="getEmployeeCode()" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control" id="add_employee_type" name="add_employee_type" required> <!-- input-sm m-bot15  -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">  
                                    <input type="text" class="form-control" placeholder="Enter Employee Name" id="add_employee_name" name="add_employee_name" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2">Employee Phone *</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Enter Phone Number" id="add_phone" name="add_phone" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control" placeholder="Enter Address" id="add_address" name="add_address" required></textarea>
							 ...
							 <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control" id="add_status" name="add_status" required> <!-- input-sm m-bot15  -->
                            ...
                            <table class="display table table-bordered" id="hidden-table-info">
                                ...
                                <tbody>
                                    <?php foreach ($get_base_employees_data as $row) :
										...
										$employee_status=$row->is_active;
										if($employee_status==1){$employee_status='Active';}else{$employee_status='Inactive';}
                                    ...
                                    <tr class="gradeX">
										...
										<td class="hidden-phone"><?php echo $employee_status; ?></td>
