...
<html lang="en">
    <head>
        ...
        <!--normal table
        <link rel="stylesheet" href="<?php echo $base_url ?>public/css/table.css" type="text/css">
        ...
        <style type="text/css">
			...
			#myTable_wrapper input[type="search"]{ border:none; }
			#myTable_length{padding:0px;}
    ...
    <section id="container" >
        ...
        <header class="header white-bg">
            <div class="sidebar-toggle-box">
             ...
             <!--logo start-->
            <a href="<?php echo site_url('home');  ?>" class="logo"><!--<img width=60px;height=auto; src="<?php //echo $base_url ?>public/img/pizzalogo.png"/>--><span style="color:#009246">Sales  </span><span style="color:#CE2B37">Tracking</span></a>
            <!--logo end-->
