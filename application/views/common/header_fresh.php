...
<html lang="en">
    ...
    <section id="container" >
        ...
        <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="<?php echo site_url('home/logout');  ?>" class="logo"><!--<img width=60px;height=auto; src="<?php //echo $base_url ?>public/img/pizzalogo.png"/>--><span style="color:#009246">SK</span><span style="color:#CE2B37">RP</span></a>
            <!--logo end-->
