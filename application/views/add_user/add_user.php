                            ...
                            <table class="display table table-bordered" id="hidden-table-info">
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <button class="btn btn-primary btn-xs" onclick="editUser(<?=$user_id?>);">Edit</button>
                                              <?php
                                              
                                           // if($role_id ==2 || $role_id ==7):
                                                    ?>                                           
                                            <button class="btn btn-danger btn-xs" onclick="deleteUser(<?=$user_id?>);">Delete</button>
                                            <button class="btn btn-warning btn-xs" onclick="changeUser(<?=$user_id?>);">Change Password</button>
                                                <?php
                                            // endif;
                                                    ?>
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('add_user/editUser');  ?>">
                    <div class="form-group">
                        ...
                        <label class="col-lg-3 col-sm-3 control-label" for="name">User Role</label>
                        <div class="col-lg-9">
...
<div class="modal fade" id="myModalChange" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('add_user/changeUser');  ?>">
                    <div class="form-group">
                       
                        <label class="col-lg-3 col-sm-3 control-label" for="name">Full Name</label>
                        <div class="col-lg-9">
                            <input type="text" placeholder="Enter Full Name" id="edit_name2" name="edit_name2" class="form-control">
                            <input type="hidden" id="edit_user_id2" name="edit_user_id2" />
                        </div>
                        <label class="col-lg-3 col-sm-3 control-label" for="name">Password</label>
                        <div class="col-lg-9">
                            <input type="text" placeholder="Enter Password" id="edit_password" name="edit_password" class="form-control">
