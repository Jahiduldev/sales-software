            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="cmxform form-horizontal tasi-form" id="addModelForm" onSubmit="return buttonDisable();"  role="form" method="post"  action="<?php echo site_url('create_models/addModel');  ?>">

                            <div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2">Model Code *</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Enter Model Code" id="add_model_code" name="add_model_code" onchange="getModelCode();"  required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Enter Model Name" id="add_model_name" name="add_model_name"  required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">  
                                    <textarea class="form-control"  placeholder="Enter Description"  id="add_description" name="add_description"  required> </textarea>
                                </div>
                            </div>
