        ...
        <div class="row">
            <div class="col-sm-12">
                <section class="panel">
					...
					<div class="row">
						<div class="col-lg-12">
							<form role="form" class="cmxform form-horizontal tasi-form" method="post"  id="RoleForm" action="<?= base_url();?>zone_report/getDateSearch">
								...
								<div class="form-group">
									...
									<div class="col-lg-4">
									   <select class="form-control" name="proccess_type">
											...
											<option <?php if(isset($type) && $type==0){echo 'Selected'; } ?> value="0">Not Assigned</option>
