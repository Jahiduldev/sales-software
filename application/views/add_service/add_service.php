...
<section id="main-content">
    <section class="wrapper site-min-height">
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading" style="font-weight:bold; background:#022164; color:#fff;">
                       Find Customer
                    </header>
        ...
        <div class="row" id="basicInfo" style="display:none">
            <div class="col-sm-12">
                <section class="panel">
					...
					Add Complain(<a href="" id="details_link" target="_blank"> View Details</a>)
                    ...
                    <div class="panel-body" style="color:black;">
                        <div class="adv-table">
								...
								<div class="form-group" style="color:black;font-weight:bold">
										<label for="inputSuccess" class="col-sm-3 control-label col-lg-3" style="color:black; font-weight:bold">Client Mobile </label>
										<div class="col-lg-9">
										
											 <input type="text" class="form-control" id="add_mobile_number" name="add_mobile_number" readonly>
									...
									<div class="form-group" style="color:black;font-weight:bold">
										<label for="inputSuccess" class="col-sm-3 control-label col-lg-3" style="color:black; font-weight:bold">Add / Update Phone Nummber *</label>
										<div class="col-lg-9">
										
											<input type="text" class="form-control" placeholder="Enter Alternative Phone Number" id="add_service_phone_alt" name="add_service_phone_alt" />
										</div>
									</div>
...
<a href="" id="details_link">View Details</a>
							</div>
							</div>
                        </div>
                    </div>
